                            ...
                            <div class="monitor">
                                <div class="monitor-header">
                                    <el-progress
                                        ...
                                        type="circle"
                                        :percentage="info.cpu.Percent"
                                    />
                                </div>
                                <div class="monitor-footer">
                                    <Cell
                                        label="CPU主频"
                                        :value="info.cpu.cpuInfo[0].modelName.split('@ ')[1]"
                                        border
                                    />
                        ...
                        <el-card v-if="info.disk" class="box-card">
                            ...
                            <div class="monitor">
                                <div class="monitor-header">
                                    <el-progress
                                        ...
                                        :percentage="
                                            Number(
                                                (
                                                    ((info.disk.total - info.disk.free) /
                                                        info.disk.total) *
                                                    100
                                                ).toFixed(2)
                                            )
                                ...
                                <div class="monitor-footer">
                                    ...
                                    <Cell
                                        label="已用磁盘"
                                        :value="info.disk.total - info.disk.free + 'G'"
                                    />
                                </div>
                            </div>
                        </el-card>
                        ...
                        <table cellspacing="0" style="width: 100%">
                            ...
                            <tbody v-if="info.diskList">
                                <tr v-for="(forList, index) in info.diskList" :key="index">
                                    <td>
                                        <div class="cell">{{ forList.path }}</div>
                                    </td>
                                    <td>
                                        <div class="cell">{{ forList.fstype }}</div>
                                    </td>
                                    <td>
                                        <div class="cell">{{ forList.total }}M</div>
                                    </td>
                                    <td>
                                        <div class="cell">{{ forList.free }}M</div>
                                    </td>
                                    <td>
                                        <div class="cell">{{ forList.used }}M</div>
                                    </td>
                                    <td>
                                        <div
                                            class="cell"
                                            :class="{ 'text-danger': forList.usedPercent > 80 }"
                                        >
                                            {{ forList.usedPercent }}%
                                        </div>
                                    </td>
