...
export default defineComponent({
    ...
    setup() {
        ...
        let getList = () => {
            state.loading = true;
            listType(addDateRange(state.queryParams, state.dateRange)).then((response) => {
                state.typeList = response.data.list;
        ...
        let statusFormat = (row, column) => {
            return selectDictLabel(this.statusOptions, parseInt(row.status));
        };
